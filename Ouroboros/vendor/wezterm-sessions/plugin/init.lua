...
--- vendored wezterm-sessions root directory
local plugin_dir = rawget(_G, "__OUROBOROS_WEZTERM_SESSIONS_DIR")

--- checks if the user is on windows
local is_windows = wezterm.target_triple == "x86_64-pc-windows-msvc"
local separator = (plugin_dir and plugin_dir:find("\\", 1, true)) and "\\" or "/"

if not plugin_dir or plugin_dir == "" then
	error("Missing __OUROBOROS_WEZTERM_SESSIONS_DIR for vendored wezterm-sessions")
end

if plugin_dir:sub(-1) == "/" or plugin_dir:sub(-1) == "\\" then
